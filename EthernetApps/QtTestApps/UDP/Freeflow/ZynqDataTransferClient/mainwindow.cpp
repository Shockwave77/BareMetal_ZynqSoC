...
void MainWindow::setupUI()
{
    ...
    connect(sendCommandButton, &QPushButton::clicked, this, &MainWindow::sendCommand);
    ...
    connect(sendHeartbeatButton, &QPushButton::clicked, this, &MainWindow::sendHeartbeat);
...
void MainWindow::connectToServer()
{
    ...
    statusLabel->setText(QString("Status: Connected to %1:%2").arg(serverAddress.toString()).arg(serverPort));
    
    logMessage(QString("Connected to Zynq server at %1:%2").arg(serverAddress.toString()).arg(serverPort));
...
void MainWindow::sendData()
{
    ...
    qint64 bytesWritten = udpSocket->writeDatagram(packet, serverAddress, serverPort);
...
void MainWindow::sendHeartbeat()
{
    ...
    QString heartbeatData = QString("Heartbeat from Qt client %1").arg(msg.sequence);
...
void MainWindow::readPendingDatagrams()
{
    while (udpSocket->hasPendingDatagrams()) {
        ...
        processReceivedData(datagram.data(), datagram.senderAddress(), datagram.senderPort());
    }
}

void MainWindow::processReceivedData(const QByteArray &data, const QHostAddress &sender, quint16 port)
{
    ...
    const DataMessage *msg = reinterpret_cast<const DataMessage*>(data.constData());
    ...
    QString receivedData = QString::fromUtf8(msg->data, static_cast<int>(msg->length));
